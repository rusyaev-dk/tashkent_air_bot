...
pollution-level-0 = Toza havo
pollution-level-1 = Qoniqarli
pollution-level-2 = Zaif guruhlar uchun zararli
pollution-level-3 = Zararli
pollution-level-4 = Juda zararli
pollution-level-5 = Hayot uchun xavfli

health-implications-0 =
    Havo sifati yaxshi. Tashqarida bo'lish xavfsiz va siz jismoniy faoliyat bilan shug'ullanishingiz mumkin. Toza havodan rohatlaning!

health-implications-1 =
    Havo sifati maqbuldir, lekin ayniqsa sezgir guruhlarda ozgina salbiy ta'sir ko'rsatishi mumkin. Ushbu guruhlar uchun uzoq vaqt ochiq havoda ta'sir qilishni cheklash tavsiya etiladi. Aksariyat odamlar xavf ostida emas.
