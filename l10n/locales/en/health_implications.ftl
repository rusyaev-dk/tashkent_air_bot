...
health-implications-3 =
    All age groups can experience serious negative health effects. It is recommended to avoid outdoor physical activity and stay indoors, especially for sensitive groups (elderly and children). It is also recommended to use air purifiers.

health-implications-4 =
    Emergency. The health of all age groups is seriously at risk. It is required to limit any activity outside, use masks and air purifiers.
