...
async def format_statistics_info(
    ...
    ru_users_count = await users_repo.get_users_count_by_language(UserLocal.language_code == "ru")
    uz_users_count = await users_repo.get_users_count_by_language(UserLocal.language_code == "uz")
    en_users_count = await users_repo.get_users_count_by_language(UserLocal.language_code == "en")
