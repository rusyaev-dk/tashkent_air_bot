...
class AQIScheduler:
    ...
    async def send_aqi_to_users(bot: Bot, di_container: AsyncContainer):
        ...
        try:
            ru_text = format_aqi_info(aqi=current_aqi, l10n=l10n.l10ns.get("ru"))
            ...
            uz_text = format_aqi_info(aqi=current_aqi, l10n=l10n.l10ns.get("uz"))
            ...
            en_text = format_aqi_info(aqi=current_aqi, l10n=l10n.l10ns.get("en"))
